...
CREATE TABLE Item (
    ...
    FOREIGN KEY (owner_id) REFERENCES UserData(user_id)
);
...
CREATE TABLE BorrowingRequest (
    ...
    FOREIGN KEY (borrower_id) REFERENCES UserData(user_id),
    FOREIGN KEY (lister_id) REFERENCES UserData(user_id),
...
CREATE TABLE LendingHistory (
    ...
    FOREIGN KEY (lender_id) REFERENCES UserData(user_id),
    FOREIGN KEY (item_id) REFERENCES Item(item_id)
);
...
CREATE TABLE Rating (
    ...
    FOREIGN KEY (rater_id) REFERENCES UserData(user_id),
    FOREIGN KEY (ratee_id) REFERENCES UserData(user_id)
);
...
CREATE TABLE Messages (
    ...
    FOREIGN KEY (sender_id) REFERENCES UserData(user_id),
    FOREIGN KEY (receiver_id) REFERENCES UserData(user_id),
    FOREIGN KEY (item_id) REFERENCES Item(item_id)
);

-- Allow users to select data from tables
GRANT SELECT ON UserData TO PUBLIC;
...
-- Users
INSERT INTO UserData (name, profile_picture, rating) VALUES
